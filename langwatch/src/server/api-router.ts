...
import { app as barenaEdgeIngestApp } from "./routes/barena-edge-ingest";
import { app as barenaInternalOtelApp } from "./routes/barena-internal-otel";
...
export function createApiRouter() {
  ...
  api.route("/", barenaEdgeIngestApp);
  api.route("/", barenaInternalOtelApp);
  api.route("/", otelApp);
