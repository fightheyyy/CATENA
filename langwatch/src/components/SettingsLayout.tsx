...
export function BarenaSettingsNavigation() {
  const { t } = useBarenaI18n();
  return (
    <>
      <MenuLink href="/settings">{t("General Settings")}</MenuLink>
      <MenuLink href="/settings/preferences">
        {t("Appearance & Language")}
      </MenuLink>
      <MenuLink href="/me/configure">{t("Agent Connection")}</MenuLink>
      ...
      <MenuLink href="/settings/teams">{t("Teams & Projects")}</MenuLink>
    </>
  );
}
...
export default function SettingsLayout({
  ...
  const adminStatus = api.user.isAdmin.useQuery(
    {},
    {
      enabled: hasOpsAccess && !isBarenaMode,
      retry: false,
  ...
  return (
    <DashboardLayout personalScope={isBarenaMode}>
      <PageLayout.Header>
        <PageLayout.Heading>{t("Settings")}</PageLayout.Heading>
      </PageLayout.Header>
      <HStack
        align="start"
        width="full"
          ...
          {isBarenaMode ? (
            ...
            <>
              ...
              >
                ...
                {showEnterpriseNav && !isLiteMember && (
                  <MenuLink href="/settings/role-bindings">
                    Role Bindings
                  </MenuLink>
                )}
                {showEnterpriseNav &&
              ...
              >
                <MenuLink href="/settings/data-retention">
                  Data Retention
                </MenuLink>
              ...
              {!isLiteMember && (
                ...
                >
                  ...
                  {isSaaS && (
                    <MenuLink href="/settings/subscription">
                      Subscription
                    </MenuLink>
                  )}
                  {!isSaaS && (
