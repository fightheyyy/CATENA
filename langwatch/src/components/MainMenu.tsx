...
export const MainMenu = React.memo(function MainMenu({
  ...
  const pendingItemsCount = api.annotation.getPendingItemsCount.useQuery(
    ...
    { enabled: !!project?.id && !isBarenaMode },
  );

  // Spiral keeps one stable, labelled product rail. The inherited compact
  // hover rail made navigation move under the pointer and hid product context.
            ...
            {isBarenaMode ? (
              ...
              <>
                <PageMenuLink
                  ...
                  label={t(projectRoutes.home.title)}
                  project={project}
                  isActive={
                ...
                >
                  <PageMenuLink
                    ...
                    label={t(projectRoutes.analytics.title)}
                    project={project}
                  ...
                  <PageMenuLink
                    ...
                    label={t(projectRoutes.traces_v2.title)}
                    project={project}
                  ...
                  <PageMenuLink
                    ...
                    label={t(projectRoutes.messages.title)}
                    project={project}
                ...
                >
                  <PageMenuLink
                    ...
                    label={t(projectRoutes.evolution.title)}
                    project={project}
                    isActive={router.pathname.includes("/evolution")}
                    showLabel={showExpanded}
                  />

                  <CollapsibleMenuGroup
                    icon={featureIcons.simulations.icon}
                    label={t(projectRoutes.simulations.title)}
                    project={project}
                    showLabel={showExpanded}
                    children={[
                      {
                        icon: featureIcons.scenarios.icon,
                        label: t(projectRoutes.scenarios.title),
                      ...
                      },
                      {
                        ...
                        label: t(projectRoutes.simulation_runs.title),
                        ...projectScopedDestination({
                  ...
                  <PageMenuLink
                    ...
                    label={t(projectRoutes.experiments.title)}
                    project={project}
                  ...
                  <PageMenuLink
                    ...
                    label={t(projectRoutes.annotations.title)}
                    project={project}
                ...
                >
                  <PageMenuLink
                    ...
                    label={t(projectRoutes.prompts.title)}
                    project={project}
                  ...
                  <PageMenuLink
                    ...
                    label={t(projectRoutes.agents.title)}
                    project={project}
                  ...
                  <PageMenuLink
                    ...
                    label={t(projectRoutes.workflows.title)}
                    project={project}
                  ...
                  <PageMenuLink
                    ...
                    label={t(projectRoutes.evaluators.title)}
                    project={project}
                  ...
                  <PageMenuLink
                    ...
                    label={t(projectRoutes.datasets.title)}
                    project={project}
                  ...
                  {hasPermission("triggers:view") && (
                    <PageMenuLink
                      ...
                      label={t(projectRoutes.automations.title)}
                      project={project}
          ...
          <VStack width="full" gap={0.5} align="start">
            {isBarenaMode ? (
              <BarenaUtilityNavigation
                ...
                showLabel={showExpanded}
                visible={!!hasPermission("organization:view") || isPublicRoute}
              />
            ) : (
              <>
                ...
                {(!!hasPermission("organization:view") || isPublicRoute) && (
                  <PageMenuLink
                    ...
                    label={t(projectRoutes.settings.title)}
                    project={project}
