...
function SettingsForm({
  ...
  const platformName = publicEnv.data?.IS_BARENA_MODE ? "Catena" : "LangWatch";
          ...
          <VStack gap={0}>
            <VStack gap={0} width="full">
                ...
                <HorizontalFormControl
                  ...
                  helper={
                    <VStack align="start" gap={1}>
                      <Text>
                        What this organization mainly uses {platformName} for.
              ...
              {organization.useCustomS3 && (
                <HorizontalFormControl
                  label="S3 Storage"
                  helper={`Configure S3 storage to host data on your own infrastructure. Leave empty to use ${platformName}'s managed storage.`}
                >
                  {hasPermission("organization:manage") ? (
