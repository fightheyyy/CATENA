...
describe("SignIn forgot-password entry point", () => {
  ...
  describe("when the deployment uses an SSO identity provider", () => {
    ...
    it("starts GitHub OAuth and preserves the requested callback", async () => {
      mockSignIn.mockResolvedValue({ ok: true });
      publicEnvRef.current = { NEXTAUTH_PROVIDER: "github" };
      searchParamsRef.current = new URLSearchParams(
        "callbackUrl=%2Fproject%2Fevolution",
      );
