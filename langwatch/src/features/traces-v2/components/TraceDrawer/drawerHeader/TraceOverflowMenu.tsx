  ...
  return (
    <Menu.Root positioning={{ placement: "bottom-end" }}>
      ...
      <Menu.Content minWidth="240px">
        ...
        <Menu.Item
          value="barena-issue"
          disabled={!project || !barenaRunId}
          onClick={() => {
            if (!project || !barenaRunId) return;
            ...
            window.location.assign(
              `/${project.slug}/evolution?${query.toString()}`,
            );
          }}
        >
          <HStack gap={2}>
            <Icon as={LuFlag} boxSize={3.5} />
            <Text>
              {barenaRunId ? "Create Barena issue" : "No Barena Run linked"}
            </Text>
          </HStack>
        </Menu.Item>
